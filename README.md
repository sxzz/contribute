...
If the project contains documentation, you can run `nr docs:dev` to start the documentation dev server. Use `nr docs:build` to build the docs for production.
...
- [sxzz/config](https://github.com/sxzz/config) - Fish shell configs and other dotfiles
- [sxzz/eslint-config](https://github.com/sxzz/eslint-config) - ESLint config
